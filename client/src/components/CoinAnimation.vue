...
@keyframes x {
  ...
  16.7% {
    box-shadow: 80px 30px 0 0 rgba(0, 0, 0, 1), 90px 30px 0 0 rgba(0, 0, 0, 1),
      ...
      100px 70px 0 0 rgba(255, 255, 255, 1), 110px 70px 0 0 rgba(255, 255, 255, 1),
      ...
      90px 100px 0 0 rgba(255, 255, 255, 1), 100px 100px 0 0 rgba(255, 255, 255, 1),
      110px 100px 0 0 rgba(255, 255, 255, 1), 120px 100px 0 0 rgba(255, 255, 255, 1),
      130px 100px 0 0 rgba(201, 109, 0, 1), 140px 100px 0 0 rgba(255, 139, 0, 1),
      150px 100px 0 0 rgba(255, 144, 0, 1), 160px 100px 0 0 rgba(255, 155, 34, 1),
      ...
      130px 110px 0 0 rgba(255, 255, 255, 1), 140px 110px 0 0 rgba(208, 114, 0, 1),
      150px 110px 0 0 rgba(255, 144, 0, 1), 160px 110px 0 0 rgba(255, 155, 34, 1),
      ...
      130px 120px 0 0 rgba(255, 255, 255, 1), 140px 120px 0 0 rgba(208, 114, 0, 1),
      150px 120px 0 0 rgba(255, 144, 0, 1), 160px 120px 0 0 rgba(255, 155, 34, 1),
      ...
      90px 130px 0 0 rgba(255, 255, 255, 1), 100px 130px 0 0 rgba(255, 255, 255, 1),
      110px 130px 0 0 rgba(255, 255, 255, 1), 120px 130px 0 0 rgba(255, 255, 255, 1),
      130px 130px 0 0 rgba(208, 114, 0, 1), 140px 130px 0 0 rgba(255, 139, 0, 1),
      150px 130px 0 0 rgba(255, 144, 0, 1), 160px 130px 0 0 rgba(255, 155, 34, 1),
      ...
      100px 140px 0 0 rgba(189, 103, 0, 1), 110px 140px 0 0 rgba(255, 255, 255, 1),
      120px 140px 0 0 rgba(212, 115, 0, 1), 130px 140px 0 0 rgba(255, 139, 0, 1),
      140px 140px 0 0 rgba(247, 144, 2, 1), 150px 140px 0 0 rgba(255, 155, 34, 1),
      ...
      120px 150px 0 0 rgba(255, 139, 0, 1), 130px 150px 0 0 rgba(255, 155, 34, 1),
      140px 150px 0 0 rgba(255, 155, 34, 1), 150px 150px 0 0 rgba(255, 174, 77, 1),
      ...
      90px 160px 0 0 rgba(255, 155, 34, 1), 100px 160px 0 0 rgba(255, 155, 34, 1),
      110px 160px 0 0 rgba(255, 155, 34, 1), 120px 160px 0 0 rgba(255, 155, 34, 1),
      130px 160px 0 0 rgba(255, 174, 77, 1), 140px 160px 0 0 rgba(255, 182, 93, 1),
      ...
      100px 170px 0 0 rgba(255, 174, 77, 1), 110px 170px 0 0 rgba(255, 174, 77, 1),
      120px 170px 0 0 rgba(255, 182, 93, 1), 130px 170px 0 0 rgba(255, 182, 93, 1),
      140px 170px 0 0 rgba(0, 0, 0, 1), 150px 170px 0 0 rgba(0, 0, 0, 1),
  ...
  42.9% {
    box-shadow: 80px 30px 0 0 rgba(0, 0, 0, 1), 90px 30px 0 0 rgba(0, 0, 0, 1),
      ...
      90px 70px 0 0 rgba(255, 255, 255, 1), 100px 70px 0 0 rgba(255, 255, 255, 1),
      110px 70px 0 0 rgba(239, 239, 239, 1), 120px 70px 0 0 rgba(226, 226, 226, 1),
      ...
      100px 100px 0 0 rgba(255, 255, 255, 1), 110px 100px 0 0 rgba(239, 239, 239, 1),
      120px 100px 0 0 rgba(226, 226, 226, 1), 130px 100px 0 0 rgba(226, 226, 226, 1),
      ...
      140px 110px 0 0 rgba(214, 212, 212, 1), 150px 110px 0 0 rgba(226, 124, 1, 1),
      160px 110px 0 0 rgba(208, 114, 0, 1), 170px 110px 0 0 rgba(0, 0, 0, 1),
      40px 120px 0 0 rgba(0, 0, 0, 1), 50px 120px 0 0 rgba(255, 182, 93, 1),
      60px 120px 0 0 rgba(255, 155, 34, 1), 70px 120px 0 0 rgba(255, 138, 0, 1),
      80px 120px 0 0 rgba(255, 139, 0, 1), 90px 120px 0 0 rgba(255, 255, 255, 1),
      ...
      140px 120px 0 0 rgba(214, 212, 212, 1), 150px 120px 0 0 rgba(226, 124, 1, 1),
      160px 120px 0 0 rgba(208, 114, 0, 1), 170px 120px 0 0 rgba(0, 0, 0, 1),
      40px 130px 0 0 rgba(0, 0, 0, 1), 50px 130px 0 0 rgba(255, 182, 93, 1),
      60px 130px 0 0 rgba(255, 174, 77, 1), 70px 130px 0 0 rgba(255, 138, 0, 1),
      80px 130px 0 0 rgba(255, 139, 0, 1), 90px 130px 0 0 rgba(255, 255, 255, 1),
      100px 130px 0 0 rgba(255, 255, 255, 1), 110px 130px 0 0 rgba(239, 239, 239, 1),
      120px 130px 0 0 rgba(226, 226, 226, 1), 130px 130px 0 0 rgba(226, 226, 226, 1),
      ...
      90px 140px 0 0 rgba(255, 139, 0, 1), 100px 140px 0 0 rgba(255, 255, 255, 1),
      110px 140px 0 0 rgba(208, 114, 0, 1), 120px 140px 0 0 rgba(226, 226, 226, 1),
      ...
      100px 160px 0 0 rgba(255, 155, 34, 1), 110px 160px 0 0 rgba(255, 155, 34, 1),
  ...
  57.1% {
    box-shadow: 90px 30px 0 0 rgba(0, 0, 0, 1), 100px 30px 0 0 rgba(0, 0, 0, 1),
      ...
      110px 70px 0 0 rgba(226, 226, 226, 1), 120px 70px 0 0 rgba(214, 212, 212, 1),
      ...
      90px 100px 0 0 rgba(208, 114, 0, 1), 100px 100px 0 0 rgba(255, 255, 255, 1),
      110px 100px 0 0 rgba(226, 226, 226, 1), 120px 100px 0 0 rgba(214, 212, 212, 1),
      ...
      90px 110px 0 0 rgba(208, 114, 0, 1), 100px 110px 0 0 rgba(255, 255, 255, 1),
      ...
      90px 120px 0 0 rgba(208, 114, 0, 1), 100px 120px 0 0 rgba(255, 255, 255, 1),
      ...
      90px 130px 0 0 rgba(208, 114, 0, 1), 100px 130px 0 0 rgba(255, 255, 255, 1),
      110px 130px 0 0 rgba(226, 226, 226, 1), 120px 130px 0 0 rgba(214, 212, 212, 1),
      ...
      110px 140px 0 0 rgba(226, 226, 226, 1), 120px 140px 0 0 rgba(255, 139, 0, 1),
      130px 140px 0 0 rgba(208, 114, 0, 1), 140px 140px 0 0 rgba(0, 0, 0, 1),
      70px 150px 0 0 rgba(0, 0, 0, 1), 80px 150px 0 0 rgba(255, 174, 77, 1),
      90px 150px 0 0 rgba(255, 144, 0, 1), 100px 150px 0 0 rgba(255, 139, 0, 1),
      110px 150px 0 0 rgba(255, 144, 0, 1), 120px 150px 0 0 rgba(208, 114, 0, 1),
      130px 150px 0 0 rgba(208, 114, 0, 1), 140px 150px 0 0 rgba(0, 0, 0, 1),
      80px 160px 0 0 rgba(0, 0, 0, 1), 90px 160px 0 0 rgba(255, 155, 34, 1),
      100px 160px 0 0 rgba(255, 155, 34, 1), 110px 160px 0 0 rgba(208, 114, 0, 1),
      120px 160px 0 0 rgba(208, 114, 0, 1), 130px 160px 0 0 rgba(0, 0, 0, 1),
      80px 170px 0 0 rgba(0, 0, 0, 1), 90px 170px 0 0 rgba(255, 182, 93, 1),
      100px 170px 0 0 rgba(255, 174, 77, 1), 110px 170px 0 0 rgba(208, 114, 0, 1),
      120px 170px 0 0 rgba(208, 114, 0, 1), 130px 170px 0 0 rgba(0, 0, 0, 1),
  ...
  71.4% {
    box-shadow: 100px 30px 0 0 rgba(0, 0, 0, 1), 110px 30px 0 0 rgba(0, 0, 0, 1),
      ...
      100px 100px 0 0 rgba(253, 144, 13, 1), 110px 100px 0 0 rgba(253, 144, 13, 1),
  ...
  85.7% {
    box-shadow: 90px 30px 0 0 rgba(0, 0, 0, 1), 100px 30px 0 0 rgba(0, 0, 0, 1),
      ...
      90px 70px 0 0 rgba(214, 212, 212, 1), 100px 70px 0 0 rgba(226, 226, 226, 1),
      ...
      90px 100px 0 0 rgba(214, 212, 212, 1), 100px 100px 0 0 rgba(226, 226, 226, 1),
      ...
      110px 110px 0 0 rgba(255, 255, 255, 1), 120px 110px 0 0 rgba(255, 139, 0, 1),
      ...
      110px 120px 0 0 rgba(255, 255, 255, 1), 120px 120px 0 0 rgba(255, 139, 0, 1),
      ...
      90px 130px 0 0 rgba(214, 212, 212, 1), 100px 130px 0 0 rgba(226, 226, 226, 1),
      110px 130px 0 0 rgba(255, 255, 255, 1), 120px 130px 0 0 rgba(239, 129, 1, 1),
      ...
      90px 140px 0 0 rgba(193, 105, 3, 1), 100px 140px 0 0 rgba(226, 226, 226, 1),
      ...
      90px 150px 0 0 rgba(255, 144, 0, 1), 100px 150px 0 0 rgba(255, 139, 0, 1),
      110px 150px 0 0 rgba(255, 144, 0, 1), 120px 150px 0 0 rgba(255, 155, 34, 1),
      ...
      100px 170px 0 0 rgba(193, 105, 3, 1), 110px 170px 0 0 rgba(255, 174, 77, 1),
  ...
  100% {
    box-shadow: 80px 30px 0 0 rgba(0, 0, 0, 1), 90px 30px 0 0 rgba(0, 0, 0, 1),
      ...
      90px 70px 0 0 rgba(226, 226, 226, 1), 100px 70px 0 0 rgba(239, 239, 239, 1),
      ...
      80px 100px 0 0 rgba(214, 212, 212, 1), 90px 100px 0 0 rgba(226, 226, 226, 1),
      100px 100px 0 0 rgba(239, 239, 239, 1), 110px 100px 0 0 rgba(255, 255, 255, 1),
      ...
      120px 110px 0 0 rgba(255, 255, 255, 1), 130px 110px 0 0 rgba(255, 139, 0, 1),
      140px 110px 0 0 rgba(255, 139, 0, 1), 150px 110px 0 0 rgba(255, 144, 0, 1),
      ...
      120px 120px 0 0 rgba(255, 255, 255, 1), 130px 120px 0 0 rgba(255, 139, 0, 1),
      140px 120px 0 0 rgba(255, 139, 0, 1), 150px 120px 0 0 rgba(255, 144, 0, 1),
      ...
      80px 130px 0 0 rgba(214, 212, 212, 1), 90px 130px 0 0 rgba(226, 226, 226, 1),
      100px 130px 0 0 rgba(239, 239, 239, 1), 110px 130px 0 0 rgba(255, 255, 255, 1),
      ...
      90px 140px 0 0 rgba(193, 105, 3, 1), 100px 140px 0 0 rgba(239, 239, 239, 1),
      110px 140px 0 0 rgba(255, 139, 0, 1), 120px 140px 0 0 rgba(255, 139, 0, 1),
      ...
      90px 150px 0 0 rgba(255, 144, 0, 1), 100px 150px 0 0 rgba(255, 139, 0, 1),
      110px 150px 0 0 rgba(255, 144, 0, 1), 120px 150px 0 0 rgba(255, 139, 0, 1),
      130px 150px 0 0 rgba(255, 155, 34, 1), 140px 150px 0 0 rgba(255, 155, 34, 1),
      ...
      100px 160px 0 0 rgba(255, 155, 34, 1), 110px 160px 0 0 rgba(255, 155, 34, 1),
      120px 160px 0 0 rgba(255, 155, 34, 1), 130px 160px 0 0 rgba(255, 174, 77, 1),
      140px 160px 0 0 rgba(247, 159, 57, 1), 150px 160px 0 0 rgba(0, 0, 0, 1),
      70px 170px 0 0 rgba(0, 0, 0, 1), 80px 170px 0 0 rgba(208, 114, 0, 1),
      90px 170px 0 0 rgba(255, 155, 34, 1), 100px 170px 0 0 rgba(255, 159, 42, 1),
      110px 170px 0 0 rgba(255, 159, 42, 1), 120px 170px 0 0 rgba(255, 174, 77, 1),
